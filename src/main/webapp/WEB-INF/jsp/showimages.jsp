...
<head>
    ...
    <meta name="msapplication-TileImage" content="image/assets/app-icon72x72@2x.png">
    ...
    <%--<script type="text/javascript">
        ...
        xmlHttp.onreadystatechange = function (){
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                ...
                var images = eval("(" + xmlHttp.responseText + ")");
                var oParent = document.getElementById("container");
                for (var i = 0; i < images.jsonArray.length; i++) {
                    var oPin = document.createElement("div");
                    oParent.appendChild(oPin);
                    var oImg = document.createElement('img');
                    oImg.src = src = "" + images.jsonArray[i];
                    oPin.appendChild(oImg);
                }
            }
        }
        xmlHttp.open("get","${path}/images/showImages",true);
        xmlHttp.send();
    </script>--%>
</head>
...
<div class="am-g am-g-fixed blog-fixed blog-content">
    <figure data-am-widget="figure" class="am am-figure am-figure-default "   data-am-figure="{  pureview: 'true' }">
        <div id="container">
            <c:forEach var="imagesList" items="${imagesList}" varStatus="index">
                <div><img src="/imgUrl/${imagesList.imagepath}"><h3>6666</h3></div>
            </c:forEach>
...
<script src="${path}/js/pinto.min.js"></script>
<script src="${path}/js/img.js"></script>
</body>
</html>