    ...
    <script type="text/javascript">
        ...
        xmlHttp.onreadystatechange = function () {
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                ...
                alert(resultJson.jsonArray.length);
                for (var i = 0; i < resultJson.jsonArray.length; i++) {
                    document.getElementById(i).innerHTML = resultJson.jsonArray[i];
                }
            }
        }
    ...
    <div class="content-left am-u-md-8 am-u-sm-12">
        <div data-am-widget="tabs" class="content-left-tab am-tabs am-tabs-default">
            ...
            <ul class="am-nav am-nav-tabs">
                <li class="am-active"><a href="${path}/blog/showAllBlog">全部</a></li>
                <c:forEach var="listtype" items="${listtype}" varStatus="index">
                    <li>
                        <a href="${path}/blog/keywordShow?typeid=${listtype.typeid}">
                                ${listtype.keyword}
                        </a>
                    </li>
                </c:forEach>
            ...
            <div class="content-left-tab-content am-tabs-bd">
                ...
                <c:forEach var="listtype" items="listtype" varStatus="index">
                    ...
                    <div class="am-tab-panel am-fade" id="${index.count}">
                        <c:forEach var="list" items="${list}">
                            <article class="am-g blog-entry-article">
                                ...
                                <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                                    <span><a href="" class="blog-color">article &nbsp;</a></span>
                                    <span> @amazeUI &nbsp;</span>
                                    <span>${list.releasedate}</span>
                                    <h1><a href="">${list.title}</a></h1>
                                    <p>${list.summary}
                                    </p>
                                    <ul>
                                        <li>
                                            <a class="am-icon-btn am-icon-hand-pointer-o am-icon-fw">${list.clilkhit}</a>
                                        </li>
                                        <li><a class="am-icon-btn am-icon-commenting-o am-icon-fw">${list.replyhit}</a>
                                        </li>
                                        <li>
